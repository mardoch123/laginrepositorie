<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium text-gray-900">Liste des cages (hors ligne)</h3>
                    ...
                    <div id="cages-container" class="mt-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Code similaire à celui de rabbits.blade.php, adapté pour les cages
            // ...
        });
    </script>
</x-app-layout>